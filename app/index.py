...
def calendar():
    ...
    webdesign = CourseType.WebDesign
    mobiledevelopment = CourseType.MobileDevelopment
    officeautomation = CourseType.OfficeAutomation
    mosofficeautomation = CourseType.MOSOfficeAutomation
    computernetworking = CourseType.ComputerNetworking
    dao.register_course()
    return render_template('/pages/calendar.html', courses=courses, webdesign=webdesign,
                           mobiledevelopment=mobiledevelopment, officeautomation=officeautomation,
                           mosofficeautomation=mosofficeautomation, computernetworking=computernetworking)
